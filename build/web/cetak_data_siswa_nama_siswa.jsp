<%-- 
    Document   : cetak_data_siswa_nama_siswa
    Created on : Jun 14, 2018, 4:25:58 PM
    Author     : Haryono
--%>
...
<head>
      ...
      <title>Cetak Data Siswa Parameter Nama Siswa</title>
</head>
<body>
...
String nama_siswa=request.getParameter("nama siswa");

Class.forName("com.mysql.jdbc.Driver");
conn = DriverManager.getConnection(url, username, password);
File reportFile = new File(application
        .getRealPath("/Report"+ "/data_siswa_nama_siswa.jasper"));

Map parameter = new HashMap();
parameter.put("nama siswa", nama_siswa);

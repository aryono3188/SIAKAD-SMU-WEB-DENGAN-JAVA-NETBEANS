...
<head>
      ...
      <title>Cetak Data Nilai Siswa Berdasarkan Nama Kelas</title>
</head>
<body>
...
String kode_kelas=request.getParameter("nama kelas");

Class.forName("com.mysql.jdbc.Driver");
conn = DriverManager.getConnection(url, username, password);
File reportFile = new File(application
        .getRealPath("/Report"+ "/data_nilai_siswa_nama_kelas.jasper"));

Map parameter = new HashMap();
parameter.put("nama kelas", kode_kelas);

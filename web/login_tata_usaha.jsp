<%-- 
    Document   : login_tata_usaha
    Created on : Jun 19, 2018, 11:48:43 PM
    Author     : Haryono
--%>
        ...
        <div class="left"> <%-- awal dari content sebelah kiri web --%>                   
                    <table width="100%">
                        ...
                        <td valign="top" width="110%">
                                ...
                                <br>
        <br>                       
        <form method="post" action="sukses_tata_usaha.jsp"> 
            <center>
            <table bgcolor="#C1DAD7" border="1" width="40%" cellpadding="20" style="border: 5px dashed red;">
                <thead>
                    <tr>
                        <th colspan="2">Login Tata Usaha</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>User Name</td>
                        <td><input type="text" name="usname_t_u" value="" /></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="pass_t_u" value="" /></td>
                    </tr>
                    <tr>

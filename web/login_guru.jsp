<%-- 
    Document   : login_guru
    Created on : Jun 17, 2018, 7:58:17 PM
    Author     : Haryono
--%>
        ...
        <div class="left"> <%-- awal dari content sebelah kiri web --%>                   
                    <table width="100%">
                        ...
                        <td valign="top" width="110%">
                                ...
                                <br>
        <br>                       
        <form method="post" action="sukses_guru.jsp"> 
            <center>
            <table bgcolor="#6295f4" border="1" width="40%" cellpadding="20" style="border: 5px dashed red;">
                <thead>
                    <tr>
                        <th colspan="2">Login Guru</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>User Name</td>
                        <td><input type="text" name="usname_guru" value="" /></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="pass_guru" value="" /></td>
                    </tr>
                    <tr>

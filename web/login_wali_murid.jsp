<%-- 
    Document   : login_wali_murid
    Created on : Jun 20, 2018, 8:08:56 PM
    Author     : Haryono
--%>
        ...
        <div class="left"> <%-- awal dari content sebelah kiri web --%>                   
                    <table width="100%">
                        ...
                        <td valign="top" width="110%">
                                ...
                                <br>
        <br>                       
        <form method="post" action="sukses_wali_murid.jsp"> 
            <center>
            <table bgcolor="burlywood" border="1" width="40%" cellpadding="20" style="border: 5px dashed red;">
                <thead>
                    <tr>
                        <th colspan="2">Login Wali Murid</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>User Name</td>
                        <td><input type="text" name="usname_wali_murid" value="" /></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="pass_wali_murid" value="" /></td>
                    </tr>
                    <tr>

<%-- 
    ...
    Created on : Apr 12, 2018, 1:46:30 PM
    Author     : Haryono
--%>
        ...
        <div class="left"> <%-- awal dari content sebelah kiri web --%>                   
                    <table width="100%">
                        ...
                        <td valign="top" width="110%">
                                ...
                                <br>
        <br>                       
        <form method="post" action="sukses_admin.jsp"> 
            <center>
            <table bgcolor="pink" border="1" width="40%" cellpadding="20" style="border: 5px dashed red;">
                ...
                <tbody>
                    <tr>
                        <td>User Name</td>
                        <td><input type="text" name="usname_admin" value="" /></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td><input type="password" name="pass_admin" value="" /></td>
                    </tr>
                    <tr>

<%-- 
    Document   : indexwali_murid
    Created on : Jun 20, 2018, 8:01:50 PM
    Author     : Haryono
--%>
           ...
           <div id="header"><%--awal header--%>
            ...
            <div id="menu"><%--awal dari menu atas --%>
                <ul>
                    ...
                    <li><a href="login_wali_murid.jsp">Logout</a></li>
                </ul>
            ...
            <center>
                <table bgcolor="pink" border="0" width="100%" cellpadding="0" cellspacing="2">                       
                                <tr class="head">
                                    <thead>
                                        <td>
                                        <center><h2>Wali Murid</h2></center>
                                        </td>
                                    </thead>
                                </tr> 
                </table>
                                    ...
                                    <ul>
                                        <tr>
                                            <td bgcolor="pink"><h3><li>
                                                <a href="indexwali_murid.jsp?halaman=update_wali_murid">Update Data Pribadi      
                                            </li></h3></td>
                                        </tr>
                                    </ul>
                            </table>                          
                        ...
                        <td valign="top" widht="150%">                           
                            <table bgcolor="gray" border="0" width="100%" cellpadding="0" cellspacing="2">                       
                                <tr class="head">
                                    ...
                                    <ul>
                                        <tr>
                                            <td bgcolor="pink"><h3><li><a href="indexwali_murid.jsp?halaman=data_update_wali_murid">Cetak Wali Murid </a></li></h3></td>
                                        </tr>
                                        <tr>
                                            <td bgcolor="pink"><h3><li><a href="indexwali_murid.jsp?halaman=data_spp_siswa">Cetak SPP Siswa</a></li></h3></td>                   
                                        </tr>
                                        <tr>
                                            <td bgcolor="pink"><h3><li><a href="indexwali_murid.jsp?halaman=data_nilai_siswa_nama_siswa">Cetak Nilai Siswa</a></li></h3></td>                   
                                        </tr>
                                    </ul>
                            </table>                          
                        </td>    
                ...
                <table width="100%">
                    <tr>
                        ...
                        <%-- isi dari content sebelah kanan --%>
                            <c:choose>
                                <c:when test="${param.halaman=='update_wali_murid'}">   
                                    <%@include file="update_wali_murid.jsp"%>
                                </c:when> 
                                <c:when test="${param.halaman=='data_update_wali_murid'}">   
                                    <%@include file="data_update_wali_murid.jsp"%>
                                </c:when> 

<%-- 
    Document   : input_nilai_siswa
    Created on : Nov 2, 2017, 5:41:59 PM
    Author     : Haryono
--%>
    ...
    <br>
     <table bgcolor="gray" border="0" width="20%" cellpadding="0" cellspacing="2">                       
         <tr class="head">
            <thead>
                <td bgcolor="pink">
                     <a href="indexguru.jsp?halaman=nilai_siswa&aksi=SIMPAN2"> Tambah Nilai Siswa </a>
                </td>
            </thead>
        </tr> 
    </table><br>
    ...
    <form action="" method="post"> <br>
     ...
     <h3> Nilai Siswa/Kelas: <% out.println(cari);%> </h3><br/>
        ...
        <%--                <a href='aksi_nilai_siswa?aksi=HAPUS&id_nilai_siswa=${rownilai_siswa[0]}'>Hapus</a> |--%>
                        <a href='indexguru.jsp?halaman=nilai_siswa&aksi=GANTI2&id_nilai_siswa=${rownilai_siswa[0]}
                           &nis=${rownilai_siswa[1]}&kode_kelas=${rownilai_siswa[2]}&kode_pelajaran=${rownilai_siswa[3]}
                           &semester=${rownilai_siswa[4]}&tahun_ajaran=${rownilai_siswa[5]}
                           &tugas=${rownilai_siswa[6]}&uts=${rownilai_siswa[7]}
                           &uas=${rownilai_siswa[8]}&nilai_raport=${rownilai_siswa[9]}'> Edit </a>                           
                    </td>
                </tr>
            </c:forEach>
        </table>
